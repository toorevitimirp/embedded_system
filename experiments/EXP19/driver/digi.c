...
static int get_block(ts_event_t * * block, int size)
{
	...
	* block = p = get_data();
	...
	pTmp=*block;
	if(pTmp->pressure!=0){
//		pTmp->x=10+(pTmp->x-430)*(230-10)/(3558-430);//marked by HHTECH wk
		pTmp->x=10+(pTmp->x-420)*(230-10)/(3658-430);//added by HHTECH wk
//		pTmp->y=10+(pTmp->y-290)*(310-10)/(2679-400);//marked by HHTECH wk
		pTmp->y=10+(pTmp->y-330)*(320-10)/(3800-330);//added by HHTECH wk
	}
	//////////////////////////////////////////////////////
