...
#if 0
int test_and_set_bit(unsigned char nr,unsigned long *key_down)
{
	int i,j;
	i=nr/32;
	j=nr%32;
...
int test_and_clear_bit(unsigned char nr,unsigned long *key_down)
{
	int i,j;
        i=nr/32;
        j=nr%32;
